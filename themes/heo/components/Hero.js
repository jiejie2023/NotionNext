  ...
  return (
    <div className='h-[165px] select-none xl:h-20 flex flex-col justify-between xl:space-y-0 xl:flex-row w-28 lg:w-48 xl:w-full xl:flex-nowrap xl:space-x-3'>
      <Link
        ...
        className='group relative overflow-hidden bg-gradient-to-r from-blue-600 to-indigo-400 flex h-20 justify-start items-center text-white rounded-xl xl:hover:w-1/2 xl:w-1/3 transition-all duration-500 ease-in'>
      ...
      <Link
        ...
        className='group relative overflow-hidden bg-gradient-to-r from-red-600 to-rose-400 flex h-20 justify-start items-center text-white rounded-xl xl:hover:w-1/2 xl:w-1/3 transition-all duration-500 ease-in'>
        <div className='font-bold lg:text-lg pl-5 relative -mt-2'>
      ...
      <Link
        ...
        className='group relative overflow-hidden bg-gradient-to-r from-green-600 to-teal-400 hidden h-20 xl:flex justify-start items-center text-white rounded-xl xl:hover:w-1/2 xl:w-1/3 transition-all duration-500 ease-in'>
  ...
  return (
    <div
      ...
      <div
        ...
        } shadow transition-all duration-200 today-card h-full bg-[#000000] rounded-xl relative overflow-hidden flex items-end`}>
        <div
          id='today-card-info'
          ...
          <div
            ...
            } flex items-center px-3 h-10 justify-center bg-[#000000] hover:bg-[#000000] transition-colors duration-100 rounded-3xl`}>
            <PlusSmall
