  ...
  return (
    <article
      ...
      <div
        data-wow-delay='.2s'
        className={
          'wow fadeInUp border bg-white dark:bg-[#1e1e1e] flex mb-4 flex-col h-[25rem] md:h-52 md:flex-row 2xl:h-96 2xl:flex-col group w-full dark:border-gray-600 hover:border-green-400  dark:hover:border-yellow-600 duration-300 transition-colors justify-between overflow-hidden rounded-xl'
        }>
        {/* 图片封面 */}
        {showPageCover && (
