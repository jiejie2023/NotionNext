        ...
        <div
          ...
          <header>
            ...
            <Link
              ...
              passHref
              className={
                ' group-hover:text-green-400 dark:hover:text-yellow-700 dark:group-hover:text-yellow-600 text-black dark:text-gray-100  line-clamp-2 replace cursor-pointer text-3xl font-extrabold leading-tight'
              }>
