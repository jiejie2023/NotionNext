const CONFIG = {
  ...
  MAGZINE_HOME_BUTTON_TEXT: '更多文章',

  MAGZINE_HOME_HIDDEN_CATEGORY: '分享杂文', //不希望在首页展示的文章分类，用英文逗号隔开

  MAGZINE_HOME_TITLE: '纸上得来终觉浅，绝知此事要躬行',
  MAGZINE_HOME_DESCRIPTION:
    '世界上只有一种英雄主义，就是认清生活真相之后,依然热爱生活————罗曼•罗兰',
  MAGZINE_HOME_TIPS: '您好！我是jiely，一名正在努力创业的毕业大学生🏆',
  ...
  MAGZINE_SOCIAL_CARD_TITLE_1: '个人成长与创业交流',
